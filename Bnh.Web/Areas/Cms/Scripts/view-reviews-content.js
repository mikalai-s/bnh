...
// NOTE: this temporary solution just to make it working
...
define(
    ...
    function ($, ko) {
        ...
        ko.bindingHandlers.slideVisible = {
            ...
            update: function (element, valueAccessor, allBindingsAccessor) {
                ...
                if (valueUnwrapped === true) {
                    $(element).show("fast"); // Make the element visible
                } else {
                    $(element).hide("fast");   // Make the element invisible
                }
            }
        };
        ...
        ko.applyBindings(window.vm = new Page(page_reviewsData), $(".review-container").closest(".brick-wrapper")[0]);
    }
);
