    ...
    public static class InitData
    {
        public static void Init()
        {
            using (var db = new BleEntities())
            {
                ...
                db.Communities.Insert(new Community { Name = "Saddlebrook", Zone = "NE", UrlId = "Saddlebrook", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Auburn Bay", Zone = "SE", UrlId = "AuburnBay", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Rock Lake Estates", Zone = "NW", UrlId = "RockLakeEstates", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Beacon Heights", Zone = "NW", UrlId = "BeaconHeights", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Cougar Ridge", Zone = "SW", UrlId = "CougarRidge", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Valley Pointe Estates", Zone = "NW", UrlId = "ValleyPointeEstates", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Valley View ", Zone = "SE", UrlId = "ValleyView", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Spring Valley Estates", Zone = "SW", UrlId = "SpringValleyEstates", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Bearspaw Willow Creek", Zone = "NW", UrlId = "BearspawWillowCreek", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Garrison Green", Zone = "SW", UrlId = "GarrisonGreen", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Walden", Zone = "SE", UrlId = "Walden", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Silverado", Zone = "SW", UrlId = "Silverado", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Evansview", Zone = "NW", UrlId = "Evansview", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Springbank Hill", Zone = "SW", UrlId = "SpringbankHill", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Cranston", Zone = "SE", UrlId = "Cranston", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Currie Barracks", Zone = "SW", UrlId = "CurrieBarracks", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Saddlestone", Zone = "NE", UrlId = "Saddlestone", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Garricon Woods", Zone = "SW", UrlId = "GarriconWoods", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Castle Keep", Zone = "SW", UrlId = "CastleKeep", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Sage Meadows", Zone = "NW", UrlId = "SageMeadows", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "New Discovery", Zone = "SW", UrlId = "NewDiscovery", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Royal Oak", Zone = "NW", UrlId = "RoyalOak", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Crestmont", Zone = "SW", UrlId = "Crestmont", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Mahogany", Zone = "SE", UrlId = "Mahogany", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Evanston", Zone = "NW", UrlId = "Evanston", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Skyview Ranch", Zone = "NE", UrlId = "SkyviewRanch", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Citylife", Zone = "NW", UrlId = "Citylife", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Coulee Way Estates", Zone = "SW", UrlId = "CouleeWayEstates", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Elmont Bay", Zone = "SW", UrlId = "ElmontBay", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "McKenzie Towne", Zone = "SE", UrlId = "McKenzieTowne", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Kincora", Zone = "NW", UrlId = "Kincora", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Evergreen", Zone = "SW", UrlId = "Evergreen", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Evansridge", Zone = "NW", UrlId = "Evansridge", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Westpark", Zone = "SW", UrlId = "Westpark", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Watermark at Bearspaw", Zone = "NW", UrlId = "WatermarkatBearspaw", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Sage Hill", Zone = "NW", UrlId = "SageHill", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "New Brighton", Zone = "SE", UrlId = "NewBrighton", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Chaparral Valley", Zone = "SE", UrlId = "ChaparralValley", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Bridlewood", Zone = "SW", UrlId = "Bridlewood", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Sherwood", Zone = "NW", UrlId = "Sherwood", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Tuscany", Zone = "NW", UrlId = "Tuscany", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Copperfield", Zone = "SE", UrlId = "Copperfield", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Quarry Park", Zone = "SE", UrlId = "QuarryPark", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Aspen Hills", Zone = "SW", UrlId = "AspenHills", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Martindale", Zone = "NE", UrlId = "Martindale", CityId = calgary.CityId });
                db.Communities.Insert(new Community { Name = "Panorama Hills", Zone = "NW", UrlId = "PanoramaHills", CityId = calgary.CityId });
            }
        }
    }
}
